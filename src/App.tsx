...
const posts = [
  {
    ...
    content: [
      ...
      {type: "link", id: uuidV4(), link: {contentLink: "AlanWehrliLC/feed", linkUrl: "https://github.com/AlanWehrliLC/feed"}},
    ],
  ...
  },
  {
    ...
    content: [
      ...
      {type: "link", id: uuidV4(), link: {contentLink: "AlanWehrliLC/Discord-Bot", linkUrl: "https://github.com/AlanWehrliLC/Discord-Bot"}},
    ],
